...
public class SimpleMqttClient : IDisposable
{
    ...
    {
        // Het wachtwoord omzetten naar een SecureString.
        string password = "!2<aN8?iXJB,C6gunk0G";
        SecureString passwordSecure = new();
        ...
        {
            Host = "bb94d8473116429a9ba45fb38f46ee6c.s1.eu.hivemq.cloud", // maak eerst een (gratis) account aan bij HiveMQ.
            Port = 8883,
            ...
            UserName = "hivemq.webclient.1764593749977",
            Password = passwordSecure // wijzig: jouw-wachtwoord (line 154)
        });
